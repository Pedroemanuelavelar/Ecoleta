...
function handleSelectedItem(event) {
    ...
    // console.log('ITEM ID: ', itemId) // Usar sempre o console log para ver se tem algum erro
    ...
    // console.log('selectedItems: ', selectedItems) // verificar se as mudanças estão certas
